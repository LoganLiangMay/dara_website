  ...
  ({ className, logo, slogan, title, subtitle, callToAction, backgroundImage, contactInfo }, ref) => {
    ...
    return (
      ...
      >
        ...
        <div className="flex w-full flex-col justify-between p-6 sm:p-8 md:w-1/2 md:p-12 lg:w-3/5 lg:p-16">
            ...
            <div>
                    ...
                    {logo && (
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                {slogan && <p className="text-[10px] sm:text-xs tracking-wider text-muted-foreground">{slogan}</p>}
                            </div>
                        </div>
                    )}
                </motion.header>
                ...
                <motion.main variants={containerVariants}>
                    ...
                    <motion.p className="mb-6 sm:mb-8 max-w-md text-sm sm:text-base md:text-lg text-muted-foreground" variants={itemVariants}>
                        {subtitle}
                    </motion.p>
                    <motion.a
                        href={callToAction.href}
                        className="inline-block bg-primary text-primary-foreground px-6 sm:px-8 py-2.5 sm:py-3 rounded-md font-semibold text-sm sm:text-base tracking-wide hover:bg-primary/90 transition-colors"
        ...
        <motion.div
          className="w-full min-h-[300px] sm:min-h-[400px] bg-cover bg-center bg-no-repeat md:w-1/2 md:min-h-full lg:w-2/5"
          style={{
